...
Cliquez sur le bouton "<> Code" vert sur github 
...
Faite clique droite dessus et cliquez sur "Extraire tout..."
...
Double cliquez sur le dossier "liseuse-web-main" pour rentrer à l'intérieur.
...
En bas à droite de l'explorateur de fichier, cliquez sur "Sélectionner un dossier"
...
Cliquez sur le logo en forme de pièce de puzzle en haut à droite.
...
Cherchez l'extension "Visionneuse" et cliquez sur le bouton en forme de punaise.
...
Cliquez sur le logo de l'éxtension.
